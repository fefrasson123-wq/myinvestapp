...
import { ArrowLeft, Check, Crown, Star, Zap, TrendingUp } from 'lucide-react';
        ...
        <header className="border-b border-border/50 bg-card/80 backdrop-blur-md sticky top-0 z-10">
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-primary tracking-tight">Planos</h1>
                <p className="text-xs text-muted-foreground">Escolha o melhor plano para você</p>
              </div>
            </div>
          </div>
        </header>
